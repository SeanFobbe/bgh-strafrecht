...
{ \scshape \Huge \bfseries Entscheidungen \\[0.5cm] \Huge \bfseries \scshape des \\[0.5cm] \Huge \bfseries \scshape Bundesgerichtshofs für Strafsachen  \\[0.5cm] \Huge \bfseries aus dem 20. Jahrhundert \\[1cm] \LARGE \bfseries (\datashort )};
