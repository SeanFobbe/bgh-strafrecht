...
{ \scshape \Huge \bfseries Entscheidungen des Bundesgerichtshofs \\[0.5cm] \Huge \bfseries \scshape des \\[0.5cm] \Huge \bfseries \scshape Strafsachen Historisch \\[0.5cm] \LARGE \bfseries (\softwareshort )};
