...
{ \Huge \bfseries \scshape Entscheidungen \\[0.5cm]
  \Huge \bfseries \scshape des \\[0.5cm]
  \Huge \bfseries \scshape Bundesgerichtshofs in Strafsachen  \\[0.5cm]
  \Huge \bfseries \scshape aus dem \\[0.5cm]
  \Huge \bfseries \scshape 20. Jahrhundert \\[1cm] \LARGE \bfseries (\softwareshort )};

\node[align=center] at ($(current page.center)+(0,2)$) 
{ \scshape \LARGE Quality Control Report};
