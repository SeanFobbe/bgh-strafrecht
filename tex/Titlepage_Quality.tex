...
{ \scshape \Huge \bfseries Corpus der Entscheidungen \\[0.5cm] \Huge \bfseries \scshape des \\[0.5cm] \Huge \bfseries \scshape Bundesgerichtshofs \\[0.5cm] \LARGE \bfseries (\softwareshort )};
