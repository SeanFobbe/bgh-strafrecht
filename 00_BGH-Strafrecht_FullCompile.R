...
files.delete <- list.files(pattern = "\\.zip|\\.jpe?g|\\.png|\\.gif|\\.pdf|\\.txt|\\.bib|\\.csv|\\.spin\\.|\\.log|\\.html?|\\.RData",
                           ignore.case = TRUE)
...
rmarkdown::render(input = "01_BGH-Strafrecht_CorpusCreation.R",
                  envir = new.env(),
                  output_file = paste0("BGH-Strafrecht_",
                                       datestamp,
...
rmarkdown::render(input = "02_BGH-Strafrecht_CodebookCreation.R",
                  envir = new.env(),
                  output_file = paste0("BGH-Strafrecht_",
                                       datestamp,
                                       "_Codebook.pdf"),
